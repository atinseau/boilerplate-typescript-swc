...
import { getOneWordByOffset, getWordById, getWordCount, searchWordLike } from '../model/word';
...
router.post('/random', async (req, res)=>{
    ...
    const max = (await getWordCount()).count;
    const rand = Math.round(Math.random() * max);
    let word = await getOneWordByOffset(rand);
